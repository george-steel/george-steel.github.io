...
\cvitem{Technologies}{FIDO2/Webauthn, MFA, OAuth, Vulkan, Lit, WebAnimations, Blink, WPT testing, W3C specs, Postgres, CockroachDB, GTK, EPUB, Flask}
...
\cventry{Dec 2024 - Feb 2025}{Software developer}{}{Pinkbot}{}{\begin{itemize}
    \item Created a new, automated billing system that replaced a previous process involving multiple, time-consuming manual steps per client.
    \item Helped to create a new authentication system for our merchant portal.
\end{itemize}}
...
\cventry{Jun 2019\,--\\Nov 2020}{Software Developer}{Chrome Animations/Interactions}{Google Canada}{}{\begin{itemize}
    ...
    \item Contributed a section to the WebAnimations spec (including the associated cross-browser \textit{Web Platform Tests}) allowing the creation and manipulation of animations targeting pseudo-elements.
...
\cventry{Summer 2010}{Intern}{Kerr Vayne Systems}{}{}{
    Created a web application to stream real-time data for schedule display in a television broadcast automation system.
    }
...
\cventry{2025}{pgxx}{}{}{\url{https://github.com/george-steel/pgxx}}{
    A high-level Postgres client for go which supports ACID/serializable transactions as well as automatic mapping of query results and parameters to and from user-defined structs.
}
\cventry{2024}{Bowfishing Blitz}{}{}{\url{https://github.com/george-steel/bowfishing-blitz}}{
    A tech demo/minigame which demonstrates my new graphical technique of clip-space planar refraction, used to render water with physically-accurate refraction without having performance costs of raytracing.
}
