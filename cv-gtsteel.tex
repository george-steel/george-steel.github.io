...
\item Contributed to the WebAnimations spec (including WPT tests) allowing the creation and manipulation of animations targeting pseudo-elements.
...
\item Contributions listed at \url{https://chromium-review.googlesource.com/q/owner:gtsteel@chromium.org}
\end{itemize}}
...
\cventry{2019}{persistent-spatial}{}{}{\url{https://hackage.haskell.org/package/persistent-spatial}}{
    A structure for storing and indexing geographic coordinates which can be used with any SQL database.
}
